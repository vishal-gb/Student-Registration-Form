...
if(isset($_POST['submit'])){
	...
	//image upload
        ...
        header("Location: fpdf-test1.php");
...
<body>
<form action="fpdf-test1.php" method="post">
	<div class="container">
...
<input type="text" class="form-control" name="Intial" placeholder="Enter Initial" required>
</div>
