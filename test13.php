...
if(isset($_POST['submit'])){
    ...
    $community_certificate = $_FILES['community_certificate']['name'];
    $tenth_certificate = $_FILES['10_certificate']['name'];
    $twelveth_certificate = $_FILES['12_certificate']['name'];


    $extsension = end(explode('.',$_FILES['studentPhoto']['name']));
    $file_ext1=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['fatherPhoto']['name']));
    $file_ext2=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['motherPhoto']['name']));
    $file_ext3=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['aadhaarPhoto']['name']));
    $file_ext4=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['cc']['name']));
    $file_ext5=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['tenC']['name']));
    $file_ext6=strtolower($extsension);
    $extsension = end(explode('.',$_FILES['tweC']['name']));
    $file_ext7=strtolower($extsension);
	...
	//image upload
      ...
      if ($scon->query($sql) === TRUE) {
        ...
        header("Location: fpdf-test3.php");
    } else {
...
<div class="row form-group">
                ...
                <div class="col">
                    ...
                    <input type="file" class="form-control-file" id="father_photo" name="father_photo" required>
                </div>
            </div>
            <div class="row form-group">
                <div class="col">
                    <label for="motherPhoto">Mother Photo</label><span class="required">*</span>
                    <input type="file" class="form-control-file" id="mother_photo" name="mother_photo" required>
                </div>
                <div class="col">
                    <label for="aadharPhoto">Aadhaar Photo</label><span class="required">*</span>
                    <input type="file" class="form-control-file" id="aadhaarphoto" name="aadhaarphoto" required>
                </div>
            </div>
            <div class="row form-group">
                <div class="col">
                    <label for="cc">Community Certificate</label>
                    <input type="file" class="form-control-file" id="community_certificate" name="community_certificate">
                </div>
                <div class="col">
                    <label for="tenC">10th Certificate</label><span class="required">*</span>
                    <input type="file" class="form-control-file" id="tenth_certificate" name="tenth_certificate" required>
                </div>
            </div>
            <div class="row form-group">
                <div class="col">
                    <label for="tweC">12th Certificate</label><span class="required">*</span>
                    <input type="file" class="form-control-file" id="twelveth_certificate" name="twelveth_certificate" required>
                </div>
